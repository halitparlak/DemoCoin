					...
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" novalidate="novalidate" id="girisform" name="girisform" action="giris.php" method="post">
							...
							<div class="fv-row mb-10">
								...
								<!--end::Label-->
								<!--begin::Input-->
								<input class="form-control form-control-lg form-control-solid" placeholder="Lütfen e-posta adresinizi giriniz" minlength="1" type="email" name="email" id="email" autocomplete="off" required>
								<!--end::Input-->
							</div>
							<!--end::Input group-->
							<!--begin::Input group-->
							<div class="fv-row mb-10">
								...
								<!--end::Wrapper-->
								<!--begin::Input-->
								<input class="form-control form-control-lg form-control-solid" placeholder="Lütfen şifrenizi giriniz" minlength="1" type="password" name="sifre" id="sifre" autocomplete="off" required>
								<!--end::Input-->
							</div>
							<!--end::Input group-->
							<!--begin::Actions-->
